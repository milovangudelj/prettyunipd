			...
			flag = (
				<svg
					...
					className={`aspect-[7/5] ${
						className ? className : "h-[15px] w-[21px]"
					}`}
				>
					<mask
						id="mask0_0_705"
				...
				>
					...
					<g mask="url(#mask0_0_516)">
						...
						<path
							fillRule="evenodd"
							clipRule="evenodd"
							d="M3 1L0.973999 1.026L0.999999 3L17.982 14.028L20.019 13.991L19.981 12.029L3 1Z"
							fill="white"
						/>
						<path
							fillRule="evenodd"
						...
						<path
							fillRule="evenodd"
							clipRule="evenodd"
							d="M18 1H20V3C20 3 8.25 10.396 3.018 14.028C2.955 14.072 1.02 14.031 1.02 14.031L0.865 12.13L18 1Z"
							fill="white"
						/>
						<path
							fillRule="evenodd"
							clipRule="evenodd"
							d="M19.043 0.972L20 2L2 14L1 13L19.043 0.972Z"
							fill="#C7152A"
						/>
						<path
							fillRule="evenodd"
